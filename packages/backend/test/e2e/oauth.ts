...
function fetchDecision(cookie: string, transactionId: string, user: ImmediateSignup, { cancel }: { cancel?: boolean } = {}): Promise<Response> {
...
async function fetchDecisionFromResponse(response: Response, user: ImmediateSignup, { cancel }: { cancel?: boolean } = {}): Promise<Response> {
...
describe('OAuth', () => {
	...
	let alice: ImmediateSignup;
	let bob: ImmediateSignup;
